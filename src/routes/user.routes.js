...
router.route("/register").post(
  //When a POST request is made to /register, the middleware and the registerUser handler function are executed sequentially.
  upload.fields([
    //Purpose: This middleware is part of the multer library, used for handling file uploads in Node.js
    {
      name: "avatar",
